...
const fetchArticle = () => {     //**variable pour recuperer un seul produit en faisant appel a api */
    ...
    .then(function(data)  {
      titleKanap(data)
      priceKanap(data)
      descriptionKanap(data)
      optionColorskanap(data)
      ToCartKanap(data)
      localStorageToCart(data)
      ...
      //articleImg.src = data.imageUrl
        articleImg.setAttribute('src',imageUrl);
        articleImg.setAttribute('alt', altTxt);
        articleImg.width = '200';
        articleImg.height = '150';
        document.body.appendChild(articleImg);
